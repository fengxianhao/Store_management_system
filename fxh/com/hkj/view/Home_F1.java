...
public class Home_F1 extends javax.swing.JFrame {
	...
	public void initComponents(){
		...
		jMenu2.setForeground(Color.gray);
		...
		jMenu3.setForeground(Color.gray);
		...
		jMenu5.setForeground(Color.gray);
		...
		jMenu6.setForeground(Color.gray);
		...
		JButton4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (a==0) {
					...
					new Trade_F1(Home_F1.this,money,b);
